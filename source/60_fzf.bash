...
# Auto-completion
# ---------------
[[ $- =~ i ]] && source "/usr/local/Cellar/fzf/0.9.3/fzf-completion.bash"
...
__fsel_tmux() {
  ...
  tmux split-window $height "bash -c 'source ~/.dotfiles/source/60_fzf.bash ; tmux send-keys -t $TMUX_PANE \"\$(__fsel)\"'"
}
