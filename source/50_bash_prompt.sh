...
# PROMPT_USER_COLOR="$(tput dim)$(tput setaf 4)"
# Color for 'at', 'in', 'on'
# PROMPT_PREPOSITION_COLOR="$(tput dim)$(tput setaf 7)"
# Color for machine name (e.g. Euclid)
# PROMPT_DEVICE_COLOR="$(tput dim)$(tput setaf 6)"
# Color for directory (e.g. ~/github/sexy-bash-prompt)
# PROMPT_DIR_COLOR="$(tput dim)$(tput setaf 2)"
# Color for git branch and symbol (e.g. master)
# PROMPT_GIT_STATUS_COLOR="$(tput dim)$(tput setaf 3)"
# Color for in progress git actions (e.g. [merge])
# PROMPT_GIT_PROGRESS_COLOR="$(tput dim)$(tput setaf 1)"
# Color for prompt symbol (e.g. $)
# PROMPT_SYMBOL_COLOR="$(tput bold)$(tput setaf 4)"
## End Set Prompt Colors
